...
<head>
  ...
  <meta property="og:description" content="Help the Heart of England Forest plant a forest by simply hugging a tree and sharing a picture. #HugATree" />
  ...
  <link rel="stylesheet" href="http://images.treesfortrees.co.uk/hugatree/css/style_v4.css">
...
?>
  ...
  <header>
    <a href="http://www.heartofenglandforest.com/" class="logo"><img src="http://images.treesfortrees.co.uk/images/logo.png" /></a>
    <nav id="nav">
   ...
   <div class="container">
    <div class="row">
      <div class="col-1">
        <h2>Help us by hugging a tree! </h2>
      </div>
    </div>
    <div class="row">
      <div class="col-2-3">
      ...
      <div class="col-1-3">
        <div class="hugtree">
          <img src="http://images.treesfortrees.co.uk/hugatree/images/hugging-tree_2.jpg" />
        </div>
      </div>
    </div>
  </div>
...
10. Trees help prevent flooding. Tree canopies slow down the rate at which rainwater reaches the ground while tree roots act effectively suck rainwater deeper underground, which is then released slowly.<br /><br />
   ...
   <div class="container share-image" id="share-image">
    ...
    <div class="row narrow">
      ...
      <div class="col-1-3 share instagram">
